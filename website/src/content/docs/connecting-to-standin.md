...
- **Bridge-side (`MAX_CALL_MINUTES`):** your own hard cap per call, useful because ElevenLabs knows nothing about your budget. See [Governors and Privacy](/elevenlabs-msteams-bridge/governors-and-privacy/).
