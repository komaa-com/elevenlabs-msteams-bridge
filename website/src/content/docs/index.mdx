...
Use the sidebar to navigate. Start with **Getting Started**, or jump to the **Configuration Reference** or **Wire Protocol**. There is also a runnable [example project](https://github.com/komaa-com/elevenlabs-msteams-bridge/tree/main/examples/basic-bridge) in the repository.
