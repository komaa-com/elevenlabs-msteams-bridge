...
const META: Record<string, { help: string; type: "counter" | "gauge" }> = {
  ...
  bridge_frames_to_agent_total: { help: "Caller audio frames relayed to ElevenLabs", type: "counter" },
  ...
  bridge_el_connect_failures_total: { help: "ElevenLabs session connect failures", type: "counter" },
};
